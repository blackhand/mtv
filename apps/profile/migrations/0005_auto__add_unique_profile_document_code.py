...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Profile', fields ['document_code']
        db.create_unique('profile_profile', ['document_code'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Profile', fields ['document_code']
        db.delete_unique('profile_profile', ['document_code'])
