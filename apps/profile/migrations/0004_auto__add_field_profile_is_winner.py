...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Profile.is_winner'
        db.add_column('profile_profile', 'is_winner', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Profile.is_winner'
        db.delete_column('profile_profile', 'is_winner')
